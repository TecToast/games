...
const { data: rtcData, send: rtcSend } = useWebSocket("wss://games.tectoast.de/webrtcserver")
  ...
  <DefaultBackground v-if="gdata">
      ...
      <div class="ml-8 flex flex-col gap-4">
        ...
        <div class="flex gap-2">
          ...
          <ControlButton @click="
            ...
            " v-if="qData" :disabled="!qData.question.audio" :class="{ 'bg-gray-800': !qData.question.audio }">Play
            track of question
          </ControlButton>
          <ControlButton @click="
            ...
            " v-if="qData" :disabled="!qData.answer.audio" :class="{ 'bg-gray-800': !qData.answer.audio }">Play track
            of answer
          </ControlButton>
          <ControlButton @click="sendWS('StopTrack', {})" v-if="qData"
    ...
    <div class="ml-8 mr-4 mt-12 flex justify-between">
      <div class="flex gap-2">
        ...
        <ControlButton @click="sendWS('Join', {})" class="bg-orange-700 p-2">Connect with Quiz-Gon Jinn</ControlButton>
