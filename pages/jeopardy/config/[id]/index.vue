...
<template>
    ...
    <div class="flex w-full flex-col items-center gap-2">
      <div class="flex items-center gap-2">
        ...
        <HelpModal name="Participants">
          ...
          <br />
          <code>/jeopardy setusers</code> command of Meister Quiz-Gon Jinn. This
          will <strong>overwrite</strong> the participants. After that, click on
          the reload button to see the new participants.
        </HelpModal>
      </div>
  ...
  <div class="fixed bottom-4 flex items-center gap-4">
    ...
    <HelpModal name="Finish">
      With "Back to overview" you can go back to the overview of your Jeopardy
      quizzes. <br /><br />
