...
<template>
  <div class="flex flex-col">
    ...
    <textarea class="mt-4 h-[10vh] w-[50vw] bg-gray-800 p-2 text-white" v-model="text"></textarea>
    <input class="mt-4 h-8 bg-gray-800 p-2 text-white" type="text" placeholder="YT-URL" v-model="audioUrl" />
    <div class="mt-4 flex items-center gap-2 bg-gray-700 p-2 text-gray-400">
      ...
      <img v-if="fileName && !fileName.endsWith('mp4')" class="w-16" :src="`/api/media/${fileName}`" :alt="fileName" />
